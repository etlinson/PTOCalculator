...
def main(arg):
    ...
    # Print final result
    if canTakeVacation:
        document.querySelector("#output").innerText = "You can take all your vacation days! :)"
    else:
        document.querySelector("#output").innerText = "You cannot take all your vacation days. :("
